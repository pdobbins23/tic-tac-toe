...
//
Bit *BitHolder::bit() const { return _bit; }
...
void BitHolder::draggedBitTo(Bit *bit, BitHolder *dst) { setBit(nullptr); }
...
void BitHolder::initHolder(const ImVec2 &position, const ImVec4 &color,
