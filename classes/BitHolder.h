...
public:
  ...
  // can you drag this bit from this holder? if not, return a different bit to
  // drag instead, or nullptr if not allowed cancelDragBit or draggedBitTo must
  // be called next an example of this would be return the bit if it can move to
  // a different holder, or nullptr if it can't move at all
  ...
  virtual void initHolder(const ImVec2 &position, const ImVec4 &color,
